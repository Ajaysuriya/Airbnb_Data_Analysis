...
def datafr():
    df= pd.read_csv("D:\Data science\Project 4\Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("D:\Data science\Project 4\Airbnb-Logo.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("D:\Data science\Project 4\Airbnb.csv")
            return df_a
